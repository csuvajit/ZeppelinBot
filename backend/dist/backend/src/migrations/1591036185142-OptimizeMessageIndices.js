...
exports.OptimizeMessageIndices1591036185142 = void 0;
const typeorm_1 = require("typeorm");
class OptimizeMessageIndices1591036185142 {
    ...
    async down(queryRunner) {
        ...
        await queryRunner.createIndex("messages", new typeorm_1.TableIndex({ columnNames: ["is_bot"] }));
        ...
        await queryRunner.createIndex("messages", new typeorm_1.TableIndex({ columnNames: ["posted_at"] }));
        await queryRunner.createIndex("messages", new typeorm_1.TableIndex({ columnNames: ["is_permanent"] }));
        ...
        await queryRunner.createIndex("messages", new typeorm_1.TableIndex({ columnNames: ["guild_id"] }));
        await queryRunner.createIndex("messages", new typeorm_1.TableIndex({ columnNames: ["channel_id"] }));
        await queryRunner.createIndex("messages", new typeorm_1.TableIndex({ columnNames: ["user_id"] }));
    }
}
exports.OptimizeMessageIndices1591036185142 = OptimizeMessageIndices1591036185142;
