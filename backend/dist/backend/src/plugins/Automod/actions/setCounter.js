...
exports.SetCounterAction = void 0;
const t = __importStar(require("io-ts"));
const helpers_1 = require("../helpers");
const CountersPlugin_1 = require("../../Counters/CountersPlugin");
const LogType_1 = require("../../../data/LogType");
exports.SetCounterAction = helpers_1.automodAction({
    configType: t.type({
        counter: t.string,
        value: t.number,
    }),
    ...
    async apply({ pluginData, contexts, actionConfig, matchResult, ruleName }) {
        ...
        countersPlugin.setCounterValue(actionConfig.counter, contexts[0].message?.channel_id || null, contexts[0].user?.id || null, actionConfig.value);
    },
});
