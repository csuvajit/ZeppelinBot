...
exports.RemoveRolesAction = void 0;
...
exports.RemoveRolesAction = helpers_1.automodAction({
    ...
    async apply({ pluginData, contexts, actionConfig, ruleName }) {
        ...
        if (rolesWeCannotRemove.length) {
            const roleNamesWeCannotRemove = rolesWeCannotRemove.map(roleId => pluginData.guild.roles.get(roleId)?.name || roleId);
            const logs = pluginData.getPlugin(LogsPlugin_1.LogsPlugin);
            logs.log(LogType_1.LogType.BOT_ALERT, {
