...
exports.SetCounterCmd = knub_1.typedGuildCommand()({
    ...
    async run({ pluginData, message, args }) {
        ...
        if (value < 0) {
            pluginUtils_1.sendErrorMessage(pluginData, message.channel, "Cannot set counter value below 0");
            return;
        }
        await setCounterValue_1.setCounterValue(pluginData, args.counterName, channel?.id ?? null, user?.id ?? null, value);
