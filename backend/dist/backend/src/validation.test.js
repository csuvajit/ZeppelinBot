...
const validatorUtils = __importStar(require("./validatorUtils"));
const ava_1 = __importDefault(require("ava"));
ava_1.default("tDeepPartial works", ava => {
    const originalSchema = t.type({
        listOfThings: t.record(t.string, t.type({
            enabled: t.boolean,
            someValue: t.number,
        })),
    });
    const deepPartialSchema = utils_1.tDeepPartial(originalSchema);
